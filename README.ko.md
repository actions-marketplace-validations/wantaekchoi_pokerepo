...
[**설치 페이지**](https://wantaekchoi.github.io/pokerepo/#setup)에서 사용자명을 넣으면 두 파일이 내용이 채워진 채로 열립니다.
...
비공식 비영리 팬 프로젝트로, 닌텐도·게임프리크·크리처스·포켓몬 컴퍼니와 제휴하거나 승인받지 않았습니다. 포켓몬 이름과 이미지의 권리는 각 권리자에게 있습니다.
